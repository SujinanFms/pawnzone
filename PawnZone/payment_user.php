...
<?php
    ...
    echo "<tbody id='myTable'>";
     ...
     while($row1 = mysqli_fetch_array($result)){
       ...
       ?>
            <td>
                <a class='btn btn-warning btn-sm' href='pay_user.php?payment_id=<?=$row1["GoldID"];?>' >ต่อดอก</a>
                <a class='btn btn-danger btn-sm' href='redeem_user.php?payment_id=<?=$row1["GoldID"];?>'>ไถ่ถอน</a>
                <a class='btn btn-info btn-sm' href='balance_user.php?payment_id=<?=$row1["GoldID"];?>'>จ่ายเงินต้น</a>
            </td>
