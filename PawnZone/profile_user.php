            ...
            <div class="card-content">
                ...
                <div class="layout_card">
                    <?php
                        ...
                        $query = "SELECT * FROM members  WHERE MBstatus = 'พนักงาน' " or die ("Error in query: $query " . mysqli_error($query));
                        $result = mysqli_query($conn, $query);
                        $path = 'userpic/';
                        while($row = mysqli_fetch_array($result)){
                            if($_SESSION['MID']==$row['MbID']){
                    ?>
                    ...
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <div class="edit">
                                <a href="editprofile_user.php?member_id=<?=$row["MbID"];?>">
