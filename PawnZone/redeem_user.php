...
<body>
    <div class="wrapper">
        ...
        <div class="container">
        <form name="form1" class="main-form needs-validation" action="insert_redeem_user.php" method="post" enctype="multipart/form-data" novalidate>
        <?php
           if($_GET["payment_id"]==''){ 
            ...
            //ยอดไถ่ถอน
            $SumRedeem = ($update_balance + $update_Pay);
                    ...
                    <div class="form-row">
                            ...
                            <div class="col ">
                                    <div class="form-group col-md-8">
                                        ...
                                        <input type="text" name="update_prices" id="update_prices" class="form-control" placeholder="บาท" maxlength="5"  value="<?php echo  $update_Price ?>" required >
                                        <div class="valid-feedback">
                                                คุณกรอกข้อมูลเรียบร้อยแล้ว!
                                            </div>
                                            <div class="invalid-feedback">
                        ...
                        <div class="modal fade" id="interest" role="dialog">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title">ไถ่ถอนทอง</h4>
                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                </div>
                                <div class="modal-body">
                                    <input type="hidden" name="Rd_CusID" size="30" value="<?php echo $update_CusID ?>">
                                    <input type="hidden" name="Rd_GoldID" size="30" value="<?php echo $update_GoldID ?>">
                                    <input type="hidden" name="Rd_Typegold" size="30" value="<?php echo $update_TypeGold ?>">
                                    
                                        <div class="form-group row">
                                            <label for="payday" class="col-sm-4 col-form-label">วันที่ไถ่ถอน</label>
                                            <div class="col-sm-8">
                                            <input type="date" name="payday_redeem" class="form-control" required >
                                                <div class="valid-feedback">
                                                    คุณกรอกข้อมูลเรียบร้อยแล้ว!
                                                </div>
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="form-group row">
                                            <label for="period" class="col-sm-4 col-form-label">ยอดเงินจำนำ</label>
                                            <div class="col-sm-8">
                                                <input type="text" name="md_price" class="form-control" value="<?php echo $update_balance ?>" readonly OnChange="fncSum();" onkeyup='fncSum()' required>
                                                <div class="valid-feedback">
                                                    คุณกรอกข้อมูลเรียบร้อยแล้ว!
                                                </div>
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="form-group row">
                                            <label for="md_payrate" class="col-sm-4 col-form-label">ดอกเบี้ย</label>
                                            <div class="col-sm-8">
                                        ...
                                        <div class="form-group row">
                                            <label for="sum" class="col-sm-4 col-form-label">ยอดไถ่ถอน</label>
                                            <div class="col-sm-8">
                                                <input type="text" name="sumredeem" id="sumredeem" value="<?php echo $SumRedeem ?>" class="form-control" placeholder="บาท" >
                                                <div class="valid-feedback">
                                                    คุณกรอกข้อมูลเรียบร้อยแล้ว!
                                                </div>
                                                <div class="invalid-feedback">
                                ...
                                <button type="submit" class="btn btn-success" name="btnpayredeem" id="btnpayredeem">ยืนยัน</button>
                               </div>
                            </div>
