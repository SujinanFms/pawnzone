...
<body>
    <div class="wrapper">
        ...
        <div class="container">
        <form name="form1" class="main-form needs-validation" action="showdata_pawngold_user.php" method="post" enctype="multipart/form-data" novalidate>
        <?php
            if($_GET["pawngold_id"]==''){ 
                echo "<script type='text/javascript'>"; 
                echo "alert('Error !!');"; 
                echo "window.location = 'Hispawngold_user.php'; "; 
                echo "</script>"; 
                }
        ...
        <div class="customform2">
            <div class="form-check col-md-12">
                ...
                <p>
                    ...
                    <div class="pawncard">
                    <a href="Hispawngold_user.php" class="btn btn-primary" id="btn" type="submit" name="submit">ย้อนกลับ</a>
                    <a href="editcus_user.php?cus_id=<?=$row["CusID"];?>" class="btn btn-warning" id="btn" type="submit" name="submit">แก้ไขข้อมูลลูกค้า</a>
                    <a href="editgold_user.php?gold_id=<?=$row2["GoldID"];?>" class="btn btn-warning" id="btn" type="submit" name="submit">แก้ไขข้อมูลทอง</a>
