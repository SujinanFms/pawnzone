                    ...
                    <div class="tbreport3">
                        <div class="table-responsive-sm">          
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <th></th>
                                    <th colspan="2">ไถ่ถอน</th>
                                    <th colspan="2">หลอม</th>
                                ...
                                <tr>
                                    <td>ทองรูปพรรณ</td>
                                    <td>'. number_format($countRT1) .'</td>
                                    <td>'. number_format($weightRT1) .'</td>
                                    <td>'. number_format($countFT1) .'</td>
                                    <td>'. number_format($weightFT1) .'</td>
                                </tr>
                                <tr>
                                    <td>ทองคำแท่ง</td>
                                    <td>'. number_format($countRT2) .'</td>
                                    <td>'. number_format($weightRT2) .'</td>
                                    <td>'. number_format($countFT2) .'</td>
                                    <td>'. number_format($weightFT2) .'</td>
                                </tr>
                                <tr>
                                    <td>รวม</td>
                                    <td>'. number_format($countR) .'</td>
                                    <td>'. number_format($weightR) .'</td>
                                    <td>'. number_format($countF) .'</td>
                                    <td>'. number_format($weightF) .'</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
