                    ...
                    <div class="tbreport2">
                        <div class="table-responsive-sm">          
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>ทองรูปพรรณ</td>
                                    <td>'. number_format($countAllT1) .'</td>
                                    <td>'. number_format($weightT1) .'</td>
                                    <td>'. number_format($countPT1) .'</td>
                                </tr>
                                <tr>
                                    <td>ทองคำแท่ง</td>
                                    <td>'. number_format($countAllT2) .'</td>
                                    <td>'. number_format($weightT2) .'</td>
                                    <td>'. number_format($countPT2) .'</td>
                                </tr>
                                <tr>
                                    <td>รวม</td>
                                    <td>'. number_format($countAll) .'</td>
                                    <td>'. number_format($weight) .'</td>
                                    <td>'. number_format($countP) .'</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
