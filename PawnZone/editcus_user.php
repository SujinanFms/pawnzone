...
<body>
    ...
    <div class="wrapper">
        ...
        <form class="main-form needs-validation" action='updatecus_user.php' method="post"  name="updatecus" id="updatecus" enctype="multipart/form-data" novalidate>
            <?php 
                if($_GET["cus_id"]==''){ 
                    echo "<script type='text/javascript'>"; 
                    echo "alert('Error !!');"; 
                    echo "window.location = 'editcus_user.php'; "; 
                    echo "</script>"; 
                    }
