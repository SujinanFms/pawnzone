<style type="text/css">
        ...
        @media print {
           .row ,  #btnprint , #sidebar , #navcontent  {
                display: none;
            }
                ...
                $output .= '
                        ...
                        <div class="table-responsive-sm">          
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>รายรับ</td>
                                    <td>'. "<font color=#00EC15 >".number_format($incomeT1)."</font>" .'</td>
                                    <td>'. "<font color=#00EC15 >".number_format($incomeT2)."</font>" .'</td>
                                </tr>
                                <tr>
                                    <td>รายจ่าย</td>
                                    <td>'. "<font color=red>".number_format($expenseT1)."</font>" .'</td>
                                    <td>'. "<font color=red>".number_format($expenseT2)."</font>" .'</td>
                                </tr>
                                <tr>
                                    <td>ยอดสุุทธิ</td>
                                    <td>'. number_format($totalT1) .'</td>
                                    <td>'. number_format($totalT2) .'</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="printpawncard">
                        <button  onClick="window.print()" class="btn btn-primary" type="submit" name="submit" id="btnprint">พิมพ์</button>
                    </div>
